...
public class User implements Serializable {
	...
	public User(long userId, String userName, String password, String email, String mobile, boolean isBlocked,
			Set<Role> roleList) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "Users [userId=" + userId + ", userName=" + userName + ", password=" + password + ", email=" + email
				+ ", mobile=" + mobile + ", isBlocked=" + confirmed +"]";
	}
